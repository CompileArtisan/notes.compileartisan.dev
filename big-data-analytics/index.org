...
- ApplicationMaster
  - This isn't a daemon, but it's a framework-specific library to manage the
    entire lifecycle of a job.
- Container
...
- Once all tasks are finished, ApplicationMaster exists and the container is
  de-allocated.
